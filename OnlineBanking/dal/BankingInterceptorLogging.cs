...
using System.Linq;
using OnlineBanking.Logging;

namespace OnlineBanking.DAL
{
    public class BankingInterceptorLogging : DbCommandInterceptor
    {
        ...
        public override void ScalarExecuted(DbCommand command, DbCommandInterceptionContext<object> interceptionContext)
        {
            ...
            {
                _logger.TraceApi("SQL Database", "BankingInterceptor.ScalarExecuted", _stopwatch.Elapsed, "Command: {0}: ", command.CommandText);
            }
